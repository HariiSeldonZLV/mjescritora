...
export class NoticiasComponent implements OnInit {
 ...
 async ngOnInit() {
  console.log('🔵 NOTICIAS - Componente cargado');
  ...
  private async cargarNoticias() {
    console.log('🔵 cargarNoticias - Inicio');
    try {
      ...
      console.log('🔵 noticias signal actualizada:', this.noticias());
  ...
  async guardarNoticia() {
    console.log('🔵 guardarNoticia - Inicio');
